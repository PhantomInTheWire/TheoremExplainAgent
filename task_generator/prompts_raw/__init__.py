...
```python
from manim import *
from manim import Scene, VGroup, Axes, Rectangle, MathTex, Create, Write, FadeOut  # Core classes and animations
...
4. Never use * or any other markdown symbol in voiceover
5. Never use the color BROWN use GRAY_BROWN or DARK_BROWN or GREY_BROWN or LIGHT_BROWN
6. Never use 'SurroundRectangle'
7. Be very careful of newline characters in your response since some of it gives me KeyError: '\n    1'"""
